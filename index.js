...
function generateHTML(data) {
    ...
    <html lang="en">
        ...
        //write a then function that Fetchs the data.username and inserts it in the GitHub API info
            //Pull User's Picture
            //Pull User's Name
            //Pull User's # of Repos
                // # GET /users/${data.username};
                // `curl -i https://api.github.com/users/${data.username}/repos`
            //Pull User's # of Followers
            //Pull User's # of Followed
            //Pull USer's # of Starred 
                // return `curl -i http://api.github.com/users/${data.username}`
